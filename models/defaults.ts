...
export const DEFAULT_FIELDS = [
  ...
  },
  {
    ...
    name: "Due Date",
    type: "string",
    llm_prompt: "due date (YYYY-MM-DD format)",
    isVisibleInList: true,
    isVisibleInAnalysis: true,
    isRequired: false,
    isExtra: false,
  },
  {
    ...
    name: "Date of Sale",
    type: "string",
    llm_prompt: "date of sale, transaction date or sale date (YYYY-MM-DD format) if not provided it will be the same as issued at date",
    isVisibleInList: false,
    isVisibleInAnalysis: true,
    isRequired: false,
    isExtra: false,
