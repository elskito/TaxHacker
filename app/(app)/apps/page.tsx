...
export default async function AppsPage() {
  ...
  return (
    <>
      ...
      <main className="flex flex-row gap-4 flex-wrap justify-center md:justify-start">
        {apps.map((app) => (
          <Link
            key={app.id}
            href={`/apps/${app.id}`}
            className="block shadow-xl w-full max-w-[400px] md:max-w-[320px] p-8 md:p-6 bg-white rounded-lg hover:shadow-md transition-shadow border-4 border-gray-100"
          >
